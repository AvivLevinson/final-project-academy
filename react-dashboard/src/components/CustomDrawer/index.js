...
const CustomDrawer = () => {
  ...
  const onDateChange = (dates)=>{
    console.log(dates);
    const day =  dates[1].diff(dates[0], 'days');
    console.log(day);
    setDays(()=>day);
  }
  ...
  const submit = (values) => {
    ...
    const { id, name, prefix, phone, message, dateTime } = values;
      ...
      >
        <Form layout="vertical" hideRequiredMark onFinish={submit}>
          ...
          <Row gutter={16}>
            ...
            <Col span={12}>
              <Form.Item name="days" label="total days">
              <Input  defaultValue={days}  value={days} />
              </Form.Item>
            </Col>
          </Row>
          <Row gutter={16}>
